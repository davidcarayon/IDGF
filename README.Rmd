...
2. `table_metrics` : Table contenant une information binaire pour chaque taxon et donnant une indication sur si le taxon considéré est halin, indiciel, ou taxon d'alerte d'un ou plusieurs paramètres d'anthropisation (et si oui, desquels). 
