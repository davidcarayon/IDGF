...
- `IDGF()` permet le calcul de l'indice et renvoie un tableau contenant les valeurs des différentes métriques (exprimées en EQR), une indication sur la robustesse de l'indice ainsi que la proportion et identité des taxons inconnus ou halins. Les résultats peuvent être exprimés en deux langues contrôlé par l'argument "lang" qui n'accepte que deux valeurs : "FR" pour français (par défaut) et "ENG" pour anglais.
